...
echo "   - Source code is mounted as a volume, so the restart picks up code changes"
echo "   - Staging runs multiple uvicorn workers; set UVICORN_ARGS='--reload --reload-dir /app/src' for hot reload"
echo ""
